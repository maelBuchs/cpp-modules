...
void ScavTrap::guardGate() { std::cout << _name << " is now in gatekeeper mode." << std::endl; }
...
void ScavTrap::attack(const std::string &target) {
    ...
    std::cout << _name << " attack (but better than a ClapTrap because he is a ScavTrap) " << target
